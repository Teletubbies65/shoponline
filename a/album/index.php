             ...
             <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="update.php?fid=<?=$data['f_id'];?>" type="button" class="btn btn-success">แก้ไข</a>
                  <a href="delete.php?fid=<?=$data['f_id'];?>&ext=<?=$data['f_ext'];?>" onClick="return confirm('ยืนยันการลบ?');"type="button" class="btn btn-sm btn-danger">ลบ</a>
                </div>
...
<footer class="text-body-secondary py-5"style="color: #000000; padding: 20px;">
  <div class="container" style="">
    ...
    <p class="float-end mb-1">
     <a href="index.php"style="color: white; font-size: 20px;">Back to top!!!</a>
    </p><h3>
    
    <p class="mb-1" style="color: white; font-size: 30px;">ย้อนกลับไปด้านบน!</h3></p>
     </p>
  </div>
</footer>
