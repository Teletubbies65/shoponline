...
<?php
                ...
                $query = "SELECT * FROM category ORDER BY c_id ASC" or die("Error:" . mysqli_error());
                ...
                echo ' <table class="table table-hover">';
                  ...
                  echo "<tr>";
                    ...
                    //แก้ไขข้อมูล
                    echo "<td><a href='type_form_edil.php?act=edit&ID=$row[0]' class='btn btn-warning btn-xs'>แก้ไข</a></td> ";  
                    //ลบข้อมูล
                    echo "<td><a href='type_form_del.php?ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'>ลบ</a></td> ";
                  echo "</tr>";
                  }
                echo "</table>";
                //5. close connection
