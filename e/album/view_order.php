...
<table width="100%" class="table">         
    <tr>
        <td width="153"><h class="f1">&nbsp;</h></td>
        <td width="153"><h class="f1">เลขที่สั่งซื้ออาหาร</h></td>
        <td width="193"><h class="f1">วันที่ - เวลา</h></td>
        <td width="150"><h class="f1">ราคารวม</h></td>
        <td width="195"><h class="f1">โต๊ะ</h></td>
        <td width="195"><h class="f1"></h></td>
    </tr>
...
?>
    ...
    <tr>
        ...
        <td><?=$data['table'];?></td>
         <td><a href="delete3.php?oid=<?=$data['oid'];?>&ext=<?=$data['ototal'];?>" onClick="return confirm('ยืนยันการลบ?');"type="button" class="btn btn-sm btn-danger">ลบ</a></td>
    </tr>
...
<footer class="text-body-secondary py-5"style="color: #000000; padding: 20px;">
  <div class="container" style="">
    ...
    <p class="float-end mb-1">
		<p class="float-end mb-1">
<a href="clear.php"style="color: white; font-size: 20px;">ลบสินค้า</a><br>
<a href="clear.php"style="color: white; font-size: 20px;">ลบสินค้าทั้งหมด</a><br>
